...
<div class="sidebar d-flex flex-column p-3">
    <a class="navbar-brand mb-4 fw-bold d-flex align-items-center gap-2" href="<?php echo e(route('dashboard')); ?>">
         <img src="<?php echo e(asset('images/snhs-logo.png')); ?>" alt="SNHS Logo" class="logo">
    ...
    <nav class="nav flex-column grow">
        ...
        <button
            type="button"
            class="nav-link d-flex justify-content-between align-items-center <?php echo e(request()->routeIs('books.*') ? ' active' : ''); ?>"
            data-bs-toggle="collapse"
            data-bs-target="#booksMenu"
            aria-expanded="<?php echo e(request()->routeIs('books.*') ? 'true' : 'false'); ?>"
        ...
        <div class="collapse ps-3 <?php echo e(request()->routeIs('books.*') ? 'show' : ''); ?>" id="booksMenu">
            

            <a class="nav-link<?php echo e(request()->routeIs('books.catalog') ? ' active' : ''); ?>"
               href="<?php echo e(route('books.catalog')); ?>">
                <i class="bi bi-book-fill"></i> Book Inventory
            </a>

             <a class="nav-link<?php echo e(request()->routeIs('books.lost-damage') ? ' active' : ''); ?>"
               href="<?php echo e(route('books.lost-damage')); ?>">
        ...
        <button
            ...
            class="nav-link d-flex justify-content-between align-items-center
                   <?php echo e(request()->routeIs('users.*') ? ' active' : ''); ?>"
            data-bs-toggle="collapse"
        ...
        <div
            class="collapse ps-3 <?php echo e(request()->routeIs('users.*') ? 'show' : ''); ?>"
            id="usersMenu"
        >
            <a class="nav-link<?php echo e(request()->routeIs('users.index') ? ' active' : ''); ?>"
               href="<?php echo e(route('users.index')); ?>">
                ...
                <a class="nav-link<?php echo e(request()->routeIs('teachers.index') ? ' active' : ''); ?>"
        ...
        <button
            type="button"
            class="nav-link d-flex justify-content-between align-items-center
                   <?php echo e(request()->routeIs('borrow.*') ? ' active' : ''); ?>"
            data-bs-toggle="collapse"
            data-bs-target="#transactionsMenu"
            aria-expanded="<?php echo e(request()->routeIs('borrow.*') ? 'true' : 'false'); ?>"
        ...
        <div
            class="collapse ps-3 <?php echo e(request()->routeIs('borrow.*') ? 'show' : ''); ?>"
            id="transactionsMenu"
        >
            <a class="nav-link<?php echo e(request()->routeIs('borrow.create') ? ' active' : ''); ?>"
               href="<?php echo e(route('borrow.create')); ?>">
                <i class="fas fa-hand-holding"></i> Borrow Book
            </a>

  <a class="nav-link<?php echo e(request()->routeIs('borrow.distribute') ? ' active' : ''); ?>"
               href="<?php echo e(route('borrow.distribute')); ?>">
                <i class="fas fa-box-open"></i> Borrow for Distribution
            </a>

            <a class="nav-link<?php echo e(request()->routeIs('borrow.return.index') ? ' active' : ''); ?>"
               href="<?php echo e(route('borrow.return.index')); ?>">
        ...
        <?php if(auth()->user()->role === 'admin'): ?>
            <a class="nav-link<?php echo e(request()->routeIs('staff.*') ? ' active' : ''); ?>"
 ...
 <!-- Reports -->
    <a class="nav-link<?php echo e(request()->routeIs('reports') ? ' active' : ''); ?>"
        ...
        <button
            type="button"
            class="nav-link d-flex justify-content-between align-items-center<?php echo e(request()->routeIs('utilities.*') ? ' active' : ''); ?>"
            data-bs-toggle="collapse"
            data-bs-target="#utilitiesMenu"
            aria-expanded="<?php echo e(request()->routeIs('utilities.*') ? 'true' : 'false'); ?>"
        ...
        <div
            class="collapse ps-3 <?php echo e(request()->routeIs('utilities.*') ? 'show' : ''); ?>"
            id="utilitiesMenu"
        >
            <a class="nav-link<?php echo e(request()->routeIs('utilities.logs') ? ' active' : ''); ?>"
               href="<?php echo e(route('utilities.logs')); ?>">
                <i class="fas fa-list"></i> Activity Logs
            </a>
            <a class="nav-link<?php echo e(request()->routeIs('utilities.archive') ? ' active' : ''); ?>"
               href="<?php echo e(route('utilities.archive')); ?>">
                <i class="fas fa-archive"></i> Archive
            </a>
            <a class="nav-link" href="<?php echo e(route('utilities.backups')); ?>">
