    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        <div class="w-full max-w-md">
            <div class="bg-card dark:bg-card-dark rounded-2xl shadow-xl p-8">
                ...
                <form method="POST" action="<?php echo e(route('admin.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-6 text-center text-sm text-muted">
                    <a href="<?php echo e(route('login')); ?>" class="text-primary hover:underline">Back to login</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\jimmu\Herd\library\resources\views/auth/create-admin.blade.php ENDPATH**/ ?>