...
<div class="no-print btn-group-print">
    <a href="<?php echo e(route('books.catalog')); ?>" class="btn btn-secondary btn-sm">← Back to Inventory</a>
...
<div class="report-meta">
    <div>
        <strong>Total Books:</strong> <?php echo e(count($books)); ?>
...
<table>
    ...
    <tbody>
    <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
        ...
        <tr>
            ...
            <td class="text-center"><?php echo e($ctrlBase); ?></td>
            <td><strong><?php echo e($book->title); ?></strong></td>
            <td><?php echo e($book->author); ?></td>
            <td><?php echo e($book->category ?? '-'); ?></td>
            <td><?php echo e($book->isbn); ?></td>
            <td class="text-center"><?php echo e($book->copies ?? 0); ?></td>
        </tr>
...
</html><?php /**PATH C:\Users\user\Herd\library\resources\views/books/print.blade.php ENDPATH**/ ?>